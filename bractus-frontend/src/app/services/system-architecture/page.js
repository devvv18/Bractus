...
const offerings = [
  {
    ...
    desc: "We design distributed systems optimized for the cloud, using microservices and serverless patterns to ensure horizontal scalability.",
  },
  {
    icon: "🗺️",
    title: "Technology Roadmapping",
    desc: "Strategic 12–36 month plans that align your technical investments with your business goals and market opportunities.",
  },
  {
    icon: "🔄",
    title: "Legacy Reshaping",
    desc: "Systematic modernization of legacy systems. We help you move away from monoliths without disrupting your day-to-day operations.",
  },
  {
    icon: "🧩",
    title: "Service Integration",
    desc: "We architect the 'glue' between your disparate software systems, ensuring data flows accurately and reliably across your organization.",
  },
  {
    icon: "📐",
    title: "Scalability Audits",
    desc: "Stressing your systems to find the breaking points. We provide a clear remediation plan to handle 10x or 100x your current traffic.",
  },
  {
    icon: "📜",
    title: "Architecture Documentation",
    desc: "Clear, visual blueprints and technical documentation that ensure your internal team understands how every component works.",
  },
];
 
const process = [
  { step: "01", title: "Discovery", desc: "We audit your current tech debt, business goals, and traffic patterns to understand the 'As-Is' state." },
  { step: "02", title: "Blueprint", desc: "We deliver a comprehensive target architecture document and a step-by-step modernization roadmap." },
  { step: "03", title: "Implementation", desc: "Working alongside your team to build the core infrastructure and transition service by service." },
  { step: "04", title: "Optimization", desc: "Fine-tuning the new architecture for maximum cost-efficiency and performance." },
];
...
export default function SystemArchitecturePage() {
  ...
  const faqs = [
    { q: "Do we have to start from scratch?", a: "Rarely. We specialize in 'strangler patterns' that allow you to modernize your system one piece at a time while keeping the lights on." },
    { q: "How do you ensure the architecture is future-proof?", a: "By following 'decoupled' design principles that allow you to swap out specific technologies without rebuilding the whole system." },
    { q: "Do you provide visual diagrams?", a: "Yes — we provide full C4 model architecture diagrams and sequence flows for all key processes." },
    { q: "Will this reduce our cloud costs?", a: "Typically, yes. Modern architectures are much more efficient at utilizing cloud resources than legacy monoliths." },
  ];
    ...
    <main style={{ minHeight: "100vh", background: "#f8f9fc", fontFamily: "'Inter', sans-serif", color: "#1a1f36" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: "760px", margin: "0 auto" }}>
          <Pill>Advisory & Strategy</Pill>
          <h1 style={{ fontSize: "clamp(34px,5.5vw,66px)", fontWeight: 800, color: "#fff", lineHeight: 1.1, margin: "20px 0 22px" }}>
            System Architecture<br /><span style={{ color: "#60a5fa" }}>Future-Proof Digital Blueprints</span>
          </h1>
          <p style={{ fontSize: "18px", color: "rgba(255,255,255,0.7)", lineHeight: 1.75, marginBottom: "40px" }}>
            Strategic blueprints for digital transformation. We design scalable frameworks and reshape legacy systems to align with your long-term goals.
          </p>
